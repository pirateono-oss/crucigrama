...
const aboutContent: Record<string, { title: string; intro: string; sections: { h: string; p: string }[] }> = {
  en: {
    title: 'About Us',
    intro: 'A new crossword puzzle every day!',
    sections: [
      { h: 'What We Offer', p: 'A new crossword puzzle every day. Free, in Spanish. Test your vocabulary and puzzle-solving skills with daily challenges.' },
  ...
  es: {
    ...
    intro: 'Un crucigrama nuevo cada día!',
    sections: [
      { h: 'Lo que Ofrecemos', p: 'Un crucigrama nuevo cada día. Gratis, en español. Pon a prueba tu vocabulario y habilidades de resolución con desafíos diarios.' },
  ...
  pt: {
    title: 'Sobre Nós',
    intro: 'Novas palavras cruzadas todos os dias!',
    sections: [
      { h: 'O que Oferecemos', p: 'Novas palavras cruzadas todos os dias. Grátis, em português. Teste seu vocabulário e habilidades de resolução com desafios diários.' },
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      <div className="mb-8 text-center">
        <Grid3X3 className="mx-auto mb-4 h-12 w-12 text-primary" />
      ...
      <div className="mt-6 flex items-center gap-2 rounded-lg border border-border bg-card p-4">
        ...
        <a href="mailto:contact@crucigrama-kohl.vercel.app" className="text-primary hover:underline">contact@crucigrama-kohl.vercel.app</a>
      </div>
    </div>
  );
}
